...
const deleteCartItem = (cartItems: CartItem[], productToDelete: CartItem): CartItem[] => cartItems.filter(cartItem => cartItem.id !== productToDelete.id)

export const setCartItems = withMatch((cartItems: CartItem[]) => createAction(CART_ACTION_TYPES.SET_CART_ITEMS, cartItems))
...
export const cartItemToDelete = (cartItems: CartItem[], productToDelete: CartItem): SetCartItems => {
